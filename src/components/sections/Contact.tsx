...
export default function Contact() {
  return (
    ...
    >
      {/* Left col */}
      <Reveal>
        <SectionLabel className="mb-[26px]">Get in touch</SectionLabel>
        <div
        ...
        <div className="mt-[34px] flex flex-col gap-2">
          {['Bogotá, Colombia', 'hello@trebol.agency'].map((item) => (
            <div
              key={item}
              className="font-mono text-[10px] tracking-[.18em] text-[var(--text-dim)] uppercase flex items-center gap-[10px]"
            >
