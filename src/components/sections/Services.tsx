  ...
  return (
    ...
    >
      ...
      <Reveal className="flex flex-col md:flex-row justify-between md:items-end mb-[70px] gap-[18px] md:gap-0">
        <div>
          <SectionLabel className="mb-[14px]">What we do</SectionLabel>
          <h2
        ...
        <p className="text-[13px] text-[var(--text-dim)] leading-[1.8] md:text-right max-w-full md:max-w-[290px]">
            ...
            <Reveal key={svc.num} delay={delays[i]}>
              <Tilt3D className="h-full">
                <div className="service-card bg-brand-black px-[42px] py-[50px] h-full hover:bg-[var(--surface-hover-strong)]">
                  <div className="font-mono text-[9px] tracking-[.22em] text-sage-muted mb-[34px]">
                    {svc.num}
                  </div>
                  <div
                  ...
                  <p className="text-[13px] text-[var(--text-dim)] leading-[1.8]">
                    {svc.desc}
                  </p>
                  <Link
                    href="#contact"
                    className="inline-flex items-center gap-2 mt-[26px] font-mono text-[9px] tracking-[.2em] uppercase text-sage-dim no-underline transition-all duration-300 hover:text-sage hover:gap-4"
                  >
